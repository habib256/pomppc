...
# jusqu'en course (Jouer, OK du nom), déclenche le vidage, capture l'écran. Journal sur stdout.
...
[ "${NORUN:-}" = 1 ] && exit 0
step "lancement"; $T "killall ScreenSaverEngine 2>/dev/null; open ~/cmr.command"; sleep 18
...
step "OK nom"; $T "osascript -e 'tell application \"System Events\" to keystroke return' 2>&1"; sleep ${RACE_WAIT:-30}
